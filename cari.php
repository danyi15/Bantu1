...
?>
    ...
    <div class="container">
      ...
      $result = mysqli_query($koneksi, "SELECT * FROM barang where barang='$caribarang' or lokasi1='$caribarang' or lokasi2='$caribarang' ");
      while($user_data = mysqli_fetch_array($result)) {
          $id = $user_data['id'];
      ...
      <div class="row workingspace">
        ...
        <div class="col">
          ...
          <a href="uidetails.php?idbarang=<?php echo $id;?>&jns=<?php echo $jns;?>" class="btn btn-primary btn-lg tombol">Detail</a>
        </div>
      </div>
      <?php 
    }
