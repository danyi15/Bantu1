...
if ($news=='penemuan') {
  ...
  $berita="Penemuan Barang";
  $filter="Ditemukan";
}else{
  $berita="Kehilangan Barang";
  $filter="Dicari";
}
?>
    <!-- CONTAINER -->
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-10 info-panel">
          <div class="row">
            <div class="col-lg">
              <h1>BERITA <?php echo $berita;?> HARI INI</h1>
      ...
      <br>
       ...
       <center>
        <p>Pilih Berita</p>
      <a href="?news=kehilangan" class="btn btn-warning">Kehilangan</a>
      <a href="?news=penemuan" class="btn btn-success">Penemuan</a>
</center>
      <!-- WorkingSpace -->
      <?php

      $result = mysqli_query($koneksi, "SELECT * FROM barang where stt='$filter' ");
      while($user_data = mysqli_fetch_array($result)) {
          $id = $user_data['id'];
      ...
      <div class="row workingspace">
        ...
        <div class="col">
          ...
          <a href="uidetails.php?idbarang=<?php echo $id;?>&jns=<?php echo $news;?>" class="btn btn-primary btn-lg tombol">Detail</a>
        </div>
      </div>
      <?php 
    }
